...
export async function execute(message) {
    ...
    if (message.content.toLowerCase().includes("sato")) return message.react("<:mns_satou_reaver:1031551310669025340>");
    if (message.content.includes("24") || message.content.toLowerCase().includes("twenty four"))
        return message.react("💀");
    if (message.content.toLowerCase().includes("xd")) return message.react("<:mns_neoLoli:1030121214938718278>");
