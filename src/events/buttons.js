...
export default {
    ...
    execute: async interaction => {
        ...
        if (interaction.isButton()) {
            ...
            // Rules Button on the Info Channel
            ...
            // Get Roles Button on the Guidelines
            ...
            if (interaction.customId === "level-roles") {
                await interaction.deferUpdate({ ephemeral: true });
                ...
                await interaction.editReply({
                    content: `**Level Roles**\nWe have a few level roles that serve as a fun way to reward our users for actively interacting with the community. To obtain these rewards, simply level up by chatting on the server!\n\n> Create a post to claim the rewards unlocked on reaching Level [10, 20, 50]\n> You can check your level by using the \`/level\` command.\n\n>>> <@&1029008293043126353>\n• Embed Permmission\n• External Emojis\n• Attachment Permission\n\n<@&1029009666203721789>\n• Custom Emoji Slot\n\n<@&1029009794947887165>\n• Custom Name Reaction\n\n<@&1029009904859615262>\n• Priority Speaker in VCs\n\n<@&1029010010052759554>\n• Custom Auto-Response\n\n<@&1029010124834082826>\n• Custom Role`,
                    components: [row],
                });
            }
        }
